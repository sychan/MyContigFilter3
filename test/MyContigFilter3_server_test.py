...
from MyContigFilter3.MyContigFilter3Impl import MyContigFilter3
from MyContigFilter3.MyContigFilter3Server import MethodContext
from MyContigFilter3.authclient import KBaseAuth as _KBaseAuth

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class MyContigFilter3Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('MyContigFilter3'):
        ...
        cls.serviceImpl = MyContigFilter3(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_MyContigFilter3_" + str(suffix)
